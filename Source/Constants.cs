...
namespace Dolittle.Runtime.Events.Azure.Storage
{
    ...
    public class Constants 
    {
        ...
        public const string CONNECTION_STRING_ENV_VARIABLE = "azure_storage_connection_string";
        public const string BLOB_CONTAINER_ENV_VARIABLE = "azure_storage_blob_container";
        public const string LOCAL_STORAGE_CONFIG_PATH = "storageConfig.json";
